...
//Erikoisosaaminen:
//1., joka pitää sisällään kaiken: kehon muokkaus, rasvanpoltto, lihasten-/ voiman hankinta, (erikois)tekniikat, kisavalmennus
//2.Ravintovalmennus: perusruokavaliosta kilpaurheilijan ravintoon ja kaikki siltä väliltä!
//3.Muutosvalmennus
const Palvelut = () => {
    return (
        <div>
            <h3>Palvelut</h3>
            <p>Tähän kuvaus PT-palveluista ja sisällöstä</p>
            <p>Erityisesti senioreille on tärkeää lihaskunnon ylläpitäminen tai kasvattaminen, jotta he selviytyisivät arjessa itsenäisesti mahdollisimman hyvin.</p>
